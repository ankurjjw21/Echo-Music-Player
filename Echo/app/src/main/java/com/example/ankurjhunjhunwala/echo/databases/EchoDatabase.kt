package com.example.ankurjhunjhunwala.echo.databases
        ...
        try {
            ...
            if (cSor.moveToFirst()) {
                do {
                    ...
                    var _song_Path = cSor.getString(cSor.getColumnIndexOrThrow(Staticated.COLUMN_SONG_PATH))

                    _songList.add(Songs(_id.toLong(), _title, _artist, _song_Path, 0))
